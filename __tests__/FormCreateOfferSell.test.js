...
import { FormCreateOfferSell } from '../src/organisms';
...
it('test onchange amount', async () => {
  ...
  const { getByTestId } = render(<FormCreateOfferSell />);
...
it('test add funds action', async () => {
  ...
  const { getByTestId } = render(
    <FormCreateOfferSell navigation={{ navigate: () => {} }} />,
  );
