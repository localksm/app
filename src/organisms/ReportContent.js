            ...
            <ScrollView>
              <View style={styles.container}>
                ...
                <Text style={styles.textEvidence}>
                  Please add any evidence you have to help the jury evaluate
                  your case, such as the transaction receipt made using the
          ...
          <FormLayout.Footer>
            <View style={styles.contentFooter}>
              <Text style={styles.textContentFooter}>
                *You’ll be charged an extra fee of $0.01 KSM to pay a mediator
                to resolve the dispute. In case the transaction is resolved in
                your favor you’ll get back $0.01 KSM.
              </Text>
              <SendAdjudicationButton
                variables={variables}
                label="Submit"
                navigation={navigation}
                //actionMediation={() => navigation.navigate('Mediation')}
              />
            </View>
          </FormLayout.Footer>
        </FormLayout.Content>
...
export default withContext(ReportContent);
